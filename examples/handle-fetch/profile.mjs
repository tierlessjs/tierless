// Shared program for the cross-process fetch demo. Both processes build a runtime
// from this so they run the identical module (resume is by instruction offset).
//
