...
//
// These four functions — encodeMessage / decodeMessage / wsPort / makePeer — are
// copied VERBATIM from src/runtime/wss.mjs. They have NO dependency on core.mjs
// (which pulls in the interpreter, Tier, Suspend, …), so the browser client can
// import just the transport without loading the whole runtime. The Node side
// (server-live.mjs) imports the real src/runtime/wss.mjs; this shim only exists so
// the browser module graph stays small and browser-safe.
//
