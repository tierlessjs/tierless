...
//     like /src/runtime/heap.mjs and /experiments/react-tiers/app/bundle.gen.mjs
//     (reached transitively from runtime.mjs) resolve over HTTP,
...
//
// Run:  node experiments/react-tiers/server-live.mjs
...
// Repo root = two levels up from experiments/react-tiers/. Everything under it is
// servable; the client's module graph (client.mjs -> transport.mjs + runtime.mjs
// -> bundle.gen.mjs + heap.mjs) all lives within it.
...
<body>
  ...
  <div id="root"></div>
  <script type="module" src="/experiments/react-tiers/public/client.mjs"></script>
</body>
</html>`;
