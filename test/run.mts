...
const cases: Case[] = [
  ...
  { file: "test/e2e/heap-serve.mts",     needs: ["§5 deref is wired into the real serving path: excision, deref-over-socket, byte-bounded coherent cache, all through makeHost/serveApp/connect"] },
