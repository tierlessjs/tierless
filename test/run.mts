...
const cases: Case[] = [
  ...
  { file: "test/probes/session-auth.mts", needs: ["sealed cookie authority: blob crossings, in-band rotation, claim/reseal, expiry, the two-tab 401 recovery, and authority-scope GET coalescing all hold"] },
