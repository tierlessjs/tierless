// GENERATED by transform.cjs from test/e2e/heap-write.src.js — do not edit by hand.
...
F.rows[F.ev.idx].score = F.ev.score; // browser edits a row -> auto-deref fetches, auto-writeback propagates back
      ...
      default: throw new RangeError("tierless: invalid pc " + F.pc + " in Edit");
    }
  }
};
...
export const BUNDLE_HASH = "8d8dacd7";
