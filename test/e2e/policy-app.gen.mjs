// GENERATED by transform.cjs from test/e2e/policy-app.src.js — do not edit by hand.
  ...
  Survey(F) {
    while (true) switch (F.pc) {
      ...
      case 5:
        ...
        F.pc = 4; break;
      default: throw new RangeError("tierless: invalid pc " + F.pc + " in Survey");
    }
  }
};
...
export const BUNDLE_HASH = "f129eed1";
