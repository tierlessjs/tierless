// GENERATED by transform.cjs from test/e2e/api-pump-app.src.js — do not edit by hand.
...
F.outcome = "deleted:" + F.del.deleted;
      ...
      default: throw new RangeError("tierless: invalid pc " + F.pc + " in Flow");
    }
  }
};
...
export const BUNDLE_HASH = "01e7c018";
