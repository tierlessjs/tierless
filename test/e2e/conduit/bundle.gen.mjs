// GENERATED by transform.cjs from test/e2e/conduit/App.src.js — do not edit by hand.
import { h, render, HomeView, ArticleView, EditorView } from "./view.mts";
...
export const PROGRAMS = {
  loadHome(F) {
    while (true) switch (F.pc) {
      ...
      default: throw new RangeError("tierless: invalid pc " + F.pc + " in loadHome");
    }
  },
  loadArticle(F) {
    while (true) switch (F.pc) {
      ...
      default: throw new RangeError("tierless: invalid pc " + F.pc + " in loadArticle");
    }
  },
  App(F) {
    while (true) switch (F.pc) {
...
F.draft = { title: F.ev.title, body: F.ev.body, tags: F.ev.tags };
      ...
      case 54:
        F.route = "home";
        F.pc = 53; break;
      default: throw new RangeError("tierless: invalid pc " + F.pc + " in App");
    }
  }
};
...
export const BUNDLE_HASH = "4270079b";
