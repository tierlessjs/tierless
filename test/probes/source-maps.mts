...
execFileSync(process.execPath, [TX, "test/e2e/cf-fixtures.src.js", cfOut, "--bare"], { cwd: ROOT });
check("without --source-map the bundle is byte-for-byte unchanged", readFileSync(cfOut, "utf8") === readFileSync(join(ROOT, "test/e2e/cf-fixtures.gen.mjs"), "utf8"));
