...
const cases = [
  ...
  { file: "test/probes/wasm-decode.mjs",          needs: ["readDeep materializes the native heap"] },
  ...
  { file: "test/probes/wasm-bigint.mjs",          needs: ["the AOT compiler runs BigInt"] },
  { file: "test/probes/wasm-regex.mjs",           needs: ["the AOT compiler runs regular expressions"] },
