...
//
// Run:  node demos/verify-live.mjs
...
const clickButton = async (page, text, scope) => {
  await page.waitForFunction(({ text, scope }) => {       // wait for the target to be present (each click re-renders async)
