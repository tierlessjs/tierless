...
export const PROGRAMS = {
  realistic(F) {
    while (true) switch (F.pc) {
      ...
      default: throw new RangeError("stackmix: invalid pc " + F.pc + " in realistic (forged continuation?)");
    }
  },
  worst(F) {
    while (true) switch (F.pc) {
...
F.acc = F.seed;
      ...
      default: throw new RangeError("stackmix: invalid pc " + F.pc + " in worst (forged continuation?)");
    }
  }
};
