// tierless/browser — the browser host: one socket, answer migrations, call actions.
...
/** Page-level configuration for the shared lazy connection the compiled "use tierless"
 *  modules use. Call before the first action fires. */
export function configureTierless(opts: { url?: string; exec?: Exec }): void;
