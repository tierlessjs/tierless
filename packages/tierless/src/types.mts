...
export interface Host {
  ...
  runLocal(peer: Peer, entry: string, args?: unknown[], opts?: { exec?: Exec; pins?: (req: ResourceRequest) => boolean; map?: (req: ResourceRequest) => ResourceRequest | null; migrate?: (req: ResourceRequest, site: { fn: string; pc: number }) => boolean; trace?: boolean }): Promise<unknown>;
