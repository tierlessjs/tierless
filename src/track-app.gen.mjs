// GENERATED by transform.cjs from src/track-app.src.js — do not edit by hand.
...
__dirty(F.model).last = F.ev.type;
      ...
      case 30:
        ...
        F.pc = 3; break;
      default: throw new RangeError("stackmix: invalid pc " + F.pc + " in Session (forged continuation?)");
    }
  }
};
