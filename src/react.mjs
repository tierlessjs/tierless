// Stackmix ⨯ React — call a mix action from a component with run-state for the UI.
//
//   import { useAction } from "stackmix/react";
//   import { rebalance } from "./actions.mjs";        // a "use mix" module
//
...
// React is a peer dependency; this module is only loaded via `stackmix/react`.
